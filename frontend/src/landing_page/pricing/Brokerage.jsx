    ...
    <div className="container">
      <div className="row p-5 mt-5 text-center border-top">
        ...
        <div className="col-12 col-md-8 p-4">
          ...
          <ul className="text-muted text-start mt-3" style={{ lineHeight: "1.8", fontSize: "14px" }}>
            <li>
              Call & Trade and RMS auto-squareoff: Additional charges of ₹50 + GST per order.
            </li>
            <li>Digital contract notes will be sent via e-mail.</li>
            <li>
              Physical copies of contract notes, if required, will be charged ₹20 per contract note.
        ...
        {/* Right Section */}
        <div className="col-12 col-md-4 p-4 d-flex justify-content-center align-items-start">
          <a href="#" className="text-decoration-none">
